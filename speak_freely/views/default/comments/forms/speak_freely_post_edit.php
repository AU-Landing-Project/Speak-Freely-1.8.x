...
if (isset($vars['entity']) && !elgg_is_logged_in()) {
	...
	if($speakfreelyformcounter != 1){  //first time, create the form..
		...
		$form_body .= "<label>" . elgg_echo('speak_freely:name') . "<br> " . elgg_view('input/text', array('name' => 'anon_name', 'value' => $_SESSION['speak_freely']['anon_name'], 'id' => 'speak_freely_name_field')) . "</label> (" . elgg_echo('speak_freely:required') . ")<br><br>";
		$form_body .= "<p class='longtext_editarea'><label>".elgg_echo("generic_comments:text")."<br />" . elgg_view('input/longtext',array('name' => 'generic_comment', 'value' => $_SESSION['speak_freely']['generic_comment'])) . "</label></p>";
